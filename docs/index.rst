...
#. Get Kuiper image:
   ...
   - **Quick option**: Download pre-built from `GitHub Actions <https://github.com/analogdevicesinc/adi-kuiper-gen/actions/workflows/kuiper2_0-build.yml>`_
...
**Get it:** Download pre-built from `GitHub Actions <https://github.com/analogdevicesinc/adi-kuiper-gen/actions/workflows/kuiper2_0-build.yml>`_ or build using the default config file.
...
**Get it:** Download pre-built from `GitHub Actions <https://github.com/analogdevicesinc/adi-kuiper-gen/actions/workflows/kuiper2_0-build.yml>`_ or enable all options in the config file.
